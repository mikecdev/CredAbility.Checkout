using Checkout.MVC.Web.Extensions;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddControllersWithViews()
                ...
                //    options.Filters.Add(typeof(AuthorizationActionFilter));
                //}
                //)
                ;
            ...
            services.AddTransient<ISKUSpecialPriceRepository, SKUSpecialPriceRepositoryMock>();
            services.AddTransient<ISKURepository, SKURepositoryMock>();
